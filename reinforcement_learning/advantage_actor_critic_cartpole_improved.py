...
http://inoryy.com/post/tensorflow2-deep-reinforcement-learning/#deep-reinforcement-learning
https://github.com/inoryy/tensorflow2-deep-reinforcement-learning


Source to prepare for RL algorithms:
...
class A2CAgent:
    ...
    def test(self, env, render=True, repeat=1):
    ...
    def train(self, env, batch_sz=64, updates=250, render=True):
...
# Test the performance before learning
agent = A2CAgent(model, entropy_c=0)
...
rewards_sum = agent.test(env, repeat=10)
print("%d out of 200" % rewards_sum) # 18 out of 200
